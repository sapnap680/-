	...
	return (
		<>
			...
			<style jsx global>{`
				...
				.staff-confirm-container .confirm-label { margin-bottom: 14px; font-size: 0.2em; font-weight: bold; color: #b88c00; letter-spacing: 0.05px; text-shadow: 0 2px 12px #fffbe7; line-height: 0.7; }
