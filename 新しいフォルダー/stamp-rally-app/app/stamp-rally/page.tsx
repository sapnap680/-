	...
	return (
		<>
			...
			<style jsx global>{`
				...
				.staff-confirm-container .confirm-label { margin-bottom: 14px; font-size: 0.45em; font-weight: bold; color: #b88c00; letter-spacing: 0.3px; text-shadow: 0 2px 12px #fffbe7; line-height: 1.0; }
